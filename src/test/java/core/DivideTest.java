...
public class DivideTest {
	...
	@Test(dependsOnMethods = "divide_test_2_param") //@Test(enabled = false)
	...
	@Test(dependsOnMethods = "divide_test_3_param") //@Test(enabled = false) (dependsOnMethod = {"divide_test_2_param", "divide_test_3_param"})
